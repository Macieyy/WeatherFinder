        ...
        return (
            <div className="column border border-white text-white mt-3">
                <div className="d-flex flex-row justify-content-end border-bottom profile-top-edge">
                    {this.state.show ? <WeatherChart profile={profile} toggleChart={this.toggleChart} /> : null}
                    <div className="p-2" onClick={this.toggleChart}><img src={Expand} alt="" id="icon" /></div>
                ...
                <div className="d-flex flex-row pt-2 ">
                    <div className="col-7 pl-4 ml-md-3  profile-weather-container font-weight-bold">
                        ...
                        <div className="row">
                            <div>
                                <p className="d-none d-md-flex text-dark">Humidity:&#160;</p><img className="d-md-none pr-2"
                                    src={Humidity} alt="" />
                            </div>
                            <div>
                        ...
                        <div className="row">
                            <div>
                                <p className="d-none d-md-flex text-dark">Temperature:&#160;</p><img className="d-md-none pr-2"
                                    src={Temp} alt="" />
                            </div>
                            <div>
